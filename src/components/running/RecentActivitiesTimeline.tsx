...
const RecentActivitiesTimeline = ({ activities }: RecentActivitiesTimelineProps) => {
  ...
  return (
    <div ref={elementRef}>
      ...
      >
        <h3 className="text-2xl font-bold mb-2">Recent Entries</h3>
              ...
              <div className="px-5 py-4 relative z-10">
                <div className="grid grid-cols-4 gap-4">
                  <div className="group/stat">
                    <div className="text-[10px] font-medium uppercase tracking-widest text-white/30 mb-1.5 group-hover/stat:text-[#FC4C02]/50 transition-colors">
                      Distance
                    </div>
                    <div className="text-lg font-semibold text-white/90 group-hover/stat:text-[#FC4C02] transition-colors">
