...
// Keep the high-resolution hero backdrop while adding overlays that tame the color band under the header.
...
const Stars = ({ enableStarfield = true }: StarsProps) => {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0" aria-hidden="true">
      ...
      {/* Top gradient softens the header transition so the purple band is no longer visible */}
      <div className="absolute inset-0 pointer-events-none bg-gradient-to-b from-black/90 via-black/40 to-transparent" />
