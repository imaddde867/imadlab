-- Move the Ritesh Bhandari mention from the end of the FL-Attack write-up to the
-- top, and drop the "my friend" phrasing for something plainer.
update public.projects
set
  full_description = $fd$Built together with [Ritesh Bhandari](https://github.com/Riteshbhandarii).

Federated learning is sold on a simple promise: your data stays on your device, only gradients leave it. This repo tests what that promise is worth. It trains a small CNN across simulated clients on CelebA, captures one client's gradient update from a single round, and runs a DLG/iDLG-style optimization attack against it ([Zhu et al. 2019](https://arxiv.org/abs/1906.08935), [Zhao et al. 2020](https://arxiv.org/abs/2001.02610)). The reconstruction comes back at 29.38 dB PSNR and 0.920 SSIM, which is a recognizable photograph of a person who never uploaded a photograph.
